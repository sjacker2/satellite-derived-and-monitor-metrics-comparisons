...
def process_nc_file(sat_file, unc_file):
    ...
    percentile_90 = unc_data['GWRPM25SIGMAFULL'].quantile(0.99, dim=['lat', 'lon'])
...
mean_df = averaged_ds.to_dataframe().reset_index()
...
df_gpd.to_file('/data/acker/ALA/NA/NAv5_GWRPM25_mean2020-2022_test.shp')
print('All done!')
